...
def base_app(instance_path, search_class, cache_config):
    ...
    app_.config.update(
        ...
        WEKO_WORKFLOW_USAGE_REPORT_WORKFLOW_NAME=WEKO_WORKFLOW_USAGE_REPORT_WORKFLOW_NAME,
    )
